INSERT INTO "menu_item" (id, title, href, icon, priority, parent_id) VALUES 
    ('d1b228de-b103-4793-a86b-82b864f09623', 'Panel de control', '/dashboard', 'dashboard', 10, NULL),
    ('6c8181e3-1dcb-4392-a4e7-275c3d2e6ac8', 'Productos', '/dashboard/products', 'basket', 9, NULL),
    ...
    ('f2effea2-23e2-4360-8a1d-29999cd8b813', 'Caja registradora', '/dashboard/cash', 'cash-register', 6, NULL),
